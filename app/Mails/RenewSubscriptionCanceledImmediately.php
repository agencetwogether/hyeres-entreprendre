...
class RenewSubscriptionCanceledImmediately extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        return new Envelope(
            ...
            subject: __('notification.renew-subscription-canceled-immediately.subject'),
        );
    }
    ...
    public function content(): Content
    {
        ...
        return new Content(
            ...
            with: [
                'greeting' => __('notification.renew-subscription-canceled-immediately.greeting'),
                'content' => new HtmlString(__('notification.renew-subscription-canceled-immediately.content', [
