...
class PaymentReceived extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        return new Envelope(
            ...
            subject: __('notification.payment-received.subject')
        );
    }
    ...
    public function content(): Content
    {
        return new Content(
            ...
            with: [
                'greeting' => __('notification.payment-received.greeting', ['name' => $this->record->name, 'firstname' => $this->record->firstname]),
                'content' => new HtmlString(__('notification.payment-received.content', ['organization' => getClientName()])),
                'internal' => false,
            ]
        );
    }
