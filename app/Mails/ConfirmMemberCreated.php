...
class ConfirmMemberCreated extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        return new Envelope(
            ...
            subject: __('notification.confirm-member-created.subject'),
        );
    }
    ...
    public function content(): Content
    {
        ...
        return new Content(
            ...
            with: [
                'greeting' => __('notification.confirm-member-created.greeting'),
                'content' => new HtmlString(__('notification.confirm-member-created.content', [
