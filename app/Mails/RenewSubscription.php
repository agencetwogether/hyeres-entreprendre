...
class RenewSubscription extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        return new Envelope(
            ...
            subject: __('notification.renew-subscription.subject'),
        );
    }
    ...
    public function content(): Content
    {
        ...
        return new Content(
            ...
            with: [
                'greeting' => __('notification.renew-subscription.greeting'),
                'content' => new HtmlString(__('notification.renew-subscription.content', [
