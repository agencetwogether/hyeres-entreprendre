<a href="annuaire/membre/{{ $member->ulid }}">
    <div
        ...
        <img class="light-mode-btn hidden object-cover" src="{{ $member->getFirstMediaUrl('company_logo', 'webp') }}"
            alt="{{ $member->company_name }}">
        <img class="dark-mode-btn object-cover" src="{{ $member->getFirstMediaUrl('company_logo', 'webp') }}"
            alt="{{ $member->company_name }}">
    </div>
</a>
